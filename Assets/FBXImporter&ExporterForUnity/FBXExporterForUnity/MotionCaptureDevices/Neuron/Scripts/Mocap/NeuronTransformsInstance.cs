...
namespace Neuron
{
	...
	{	
		...
		Transform[]							transforms = new Transform[(int)NeuronBones.NumOfBones];
		...
		new void Update()
		{
			...
			{				
				...
				ApplyMotion( boundActor, transforms, ref lastEvaluateTime, bonePositionOffsets, boneRotationOffsets );
			}
		}
		...
		bool Bind( Transform root, string prefix )
		{
			this.root = root;
			this.prefix = prefix;
